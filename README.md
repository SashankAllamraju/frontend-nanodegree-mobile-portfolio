...
* Compressed and resized relevant images
* Changed querySelector() to getElementById()
* Changed querySelectorAll() to getElementsByClassName()
* Moved getElement* selectors outside of loops
* Reduced no. of sliding pizzas.
* Moved computation of new pizza size outside loop.
* Minified main.js
